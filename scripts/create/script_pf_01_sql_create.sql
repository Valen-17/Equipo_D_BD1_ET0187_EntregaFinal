...
CREATE TABLE municipio (
    id_municipio BIGINT PRIMARY KEY NOT NULL,
...
CREATE TABLE evaluacion (
    ...
    puntaje NUMERIC(5,2) NOT NULL DEFAULT 0 CHECK (puntaje >= 0 AND puntaje <= 5),
    comentario TEXT NOT NULL,
    id_proyecto INT NOT NULL,
    id_usuario INT NOT NULL,
    criterio1 BOOLEAN NOT NULL,
    criterio2 BOOLEAN NOT NULL,
    criterio3 BOOLEAN NOT NULL,
    criterio4 BOOLEAN NOT NULL,
    criterio5 BOOLEAN NOT NULL,
    criterio6 BOOLEAN NOT NULL,
    criterio7 BOOLEAN NOT NULL,
    criterio8 BOOLEAN NOT NULL,
    criterio9 BOOLEAN NOT NULL,
    criterio10 BOOLEAN NOT NULL,
